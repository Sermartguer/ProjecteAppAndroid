...
public class SeriesAdapter extends ArrayAdapter<Book> {
    ...
    public SeriesAdapter(Context context, ArrayList<Book> aBooks) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SeriesAdapter.ViewHolder viewHolder; // view lookup cache stored in tag
        if (convertView == null) {
            viewHolder = new SeriesAdapter.ViewHolder();
            LayoutInflater inflater = (LayoutInflater)getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.item_serie, parent, false);
        ...
        viewHolder.tvRdate.setText(book.getFRdate());
