...
public class MorePopMovie extends AppCompatActivity {

    private String TAG = MorePopMovie.class.getSimpleName();
    ...
    private static String url = "https://api.themoviedb.org/3/movie/popular?api_key=2c5b24e9895c627d2e1a2cdaf1c2dbe5&language=en-US&page=1";
    ...
    public class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MorePopMovie.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        Comidas.MorePopular.add(new Comida(vote, name, R.drawable.ic_nocover,email,3f,1,778,"03/24/2017",img));
                    }
