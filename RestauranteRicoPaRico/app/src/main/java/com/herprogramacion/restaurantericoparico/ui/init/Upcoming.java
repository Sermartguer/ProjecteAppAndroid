...
public class Upcoming extends AppCompatActivity {
    ...
    private String TAG = Upcoming.class.getSimpleName();
    ...
    private static String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=2c5b24e9895c627d2e1a2cdaf1c2dbe5&language="+lan()+"&page=1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Upcoming.GetContacts().execute();
        finish();
    }
    ...
    public class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Upcoming.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        contact.put("release_date", date);
                       // contact.put("vote_count", pop);
                        // adding contact to contact list
                        Comidas.Upcoming.add(new Comida(id,vote, name, img,email,3f,1,101,date,img));
                    }
