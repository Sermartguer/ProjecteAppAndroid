...
public class OnAir extends AppCompatActivity {

    private String TAG = OnAir.class.getSimpleName();
    ...
    public class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(OnAir.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        Comidas.OnAir.add(new Comida(vote, name, R.drawable.ic_nocover,email,3f,1,778,"03/24/2017",img));
                    }
