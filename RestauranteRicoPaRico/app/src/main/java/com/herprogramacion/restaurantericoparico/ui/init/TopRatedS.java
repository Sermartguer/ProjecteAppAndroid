...
public class TopRatedS extends AppCompatActivity {

    private String TAG = TopRatedS.class.getSimpleName();
    ...
    private static String url = "https://api.themoviedb.org/3/tv/top_rated?api_key=2c5b24e9895c627d2e1a2cdaf1c2dbe5&language=en-US&page=1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new TopRatedS.GetContacts().execute();
        finish();
    }
    ...
    public class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(TopRatedS.this);
